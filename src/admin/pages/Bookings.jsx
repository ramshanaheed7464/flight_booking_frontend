...
import {
    ...
    User, Globe, Phone, Utensils, ChevronDown, ChevronUp
} from 'lucide-react';
...
function PassengerDetails({ passengers }) {
    ...
    return (
        <div className="bc-pax-section">
            <button className="bc-pax-toggle" onClick={() => setOpen(o => !o)}>
                <Users size={11} />
                Passenger Details
                {open ? <ChevronUp size={12} /> : <ChevronDown size={12} />}
            </button>
            {open && (
                <div className="bc-pax-list">
                    {passengers.map((p, i) => (
                        <div key={i} className="bc-pax-card">
                            <div className="bc-pax-title">
                                <User size={11} />
                                Passenger {i + 1}
                                {p.fullName && <span className="bc-pax-name">{p.fullName}</span>}
                            </div>
                            <div className="bc-pax-grid">
                                {[
                                    { label: 'Passport No.', val: p.passportNumber },
                                    { label: 'Nationality', val: p.nationality, icon: <Globe size={10} /> },
                                    { label: 'Date of Birth', val: p.dateOfBirth },
                                    { label: 'Gender', val: p.gender },
                                    { label: 'Phone', val: p.phone, icon: <Phone size={10} /> },
                                    { label: 'Meal', val: p.mealPreference, icon: <Utensils size={10} /> },
                                ].map(({ label, val, icon }) => val ? (
                                    <div key={label} className="bc-pax-field">
                                        <span className="bc-pax-lbl">{icon}{label}</span>
                                        <span className="bc-pax-val">{val}</span>
                                    </div>
                                ) : null)}
                            </div>
                        </div>
    ...
    return (
        <div className="bc">
            ...
            <div className="bc-body">
                ...
                <PassengerDetails passengers={booking.passengerDetails} />
        ...
        <div className="bc bc-roundtrip">
            ...
            <div className="bc-leg">
                ...
                <div className="bc-body bc-leg-body" style={{ opacity: outStatus === 'CANCELLED' ? 0.45 : 1 }}>
                    ...
                    <PassengerDetails passengers={outbound.passengerDetails} />
                </div>
            </div>
            ...
            <div className="bc-leg">
                ...
                <div className="bc-body bc-leg-body" style={{ opacity: retStatus === 'CANCELLED' ? 0.45 : 1 }}>
                    ...
                    <PassengerDetails passengers={returnLeg.passengerDetails} />
                </div>
            </div>
