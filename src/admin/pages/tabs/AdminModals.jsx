...
export function FlightModal({ flight, onClose, onSaved }) {
    ...
    const validate = () => runValidators({
        ...
        inflightEntertainment: form.isEntertainmentAvailable === 'false' ? null : validateInflightEntertainment(form.inflightEntertainment),
        entertainmentDetails: form.isEntertainmentAvailable === 'false' ? null : validateEntertainmentDetails(form.inflightEntertainment, form.isEntertainmentAvailable),
